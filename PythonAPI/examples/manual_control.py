...
class Mirror(object):
    def __init__(self, parent_actor, dim, pos, topic, world_position, world_rotation):
        print('INIT MIRROR')
        self._parent = parent_actor
        self.dim = dim
        self.position = pos
        ...
        self.view_publisher = rospy.Publisher(topic[0], Image, queue_size=1, latch=False)
